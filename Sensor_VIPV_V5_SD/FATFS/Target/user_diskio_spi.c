...
#define CS_HIGH()	{HAL_GPIO_WritePin(PMOD_SPI2_CSN_GPIO_Port, PMOD_SPI2_CSN_Pin, GPIO_PIN_SET);}
#define CS_LOW()	{HAL_GPIO_WritePin(PMOD_SPI2_CSN_GPIO_Port, PMOD_SPI2_CSN_Pin, GPIO_PIN_RESET);}
